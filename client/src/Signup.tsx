...
function Signup() {
    ...
    return (
        <Container className={classes.formBox}>
            ...
            <Typography variant="body1" component="caption">Already have an account? <Link to="/login">Log In</Link> </Typography>

            <Grid container spacing={8}>
                <Grid item className={classes.positionOptions}>
                    <div className={classes.centerText}>
                        <div className={classes.imageBackground}></div>
                        <Typography variant="body1" component="caption">Are you a non-profit organization?</Typography>
                ...
                <Grid item className={classes.positionOptions}>
                    <div className={classes.centerText}>
                        <div className={classes.imageBackground}></div>
                        <Typography variant="body1" component="caption">Are you an individual citizen?</Typography>
