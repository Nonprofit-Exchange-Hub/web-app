...
3. If using postgres-dockerized workflow, from `/server` directory, run `npm run start:dev:db`
...
4. To start Nest backend in watch mode: From `/server` directory, run `npm run start:dev`
